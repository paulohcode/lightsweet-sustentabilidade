	...
	<header>
		<div class>
			<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
				<div class="eco_logo">
					<a href="index.php"><img src="images/lightsweet-logo.png" class="img-responsive" alt="">
					</a>
				</div>
			</div>
					...
					<nav class="navbar navbar-inverse" role="navigation">
						...
						<div id="main-nav" class="collapse navbar-collapse padding_left">
							<ul class="nav navbar-nav my_menu">
								...
								<li class="eco_pos_rel"><a href="https://www.lightsweet.com.br/contato/" target="_blank">Contato</a>
		...
		<div class="container">
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<div class="eco_footer_data">
					<a href="#" class="eco_footer_title"><img src="images/lightsweet-logo.png" class="img-responsive" alt="">
					</a>
					<div class="eco_footer_content">
						<p>Nós pensamos diferente, pensamos em direção a uma vida mais saudável, assim, nosso propósito é oferecer ao consumidor uma variedade de produtos em que todos possam consumir por opção e não por obrigação.</p>
					</div>
				</div>
			</div>
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
